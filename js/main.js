var alphaDust = function () {
    ...
    function _menuShow () {
        $('nav:not(.nav-left) a').addClass('menu-active');
        $('.menu-bg').show();
        ...
        $('.menu-bg').hover(function () {
            $('nav:not(.nav-left) a').toggleClass('menu-close-hover');
        });
    }

    function _menuHide() {
        $('nav:not(.nav-left) a').removeClass('menu-active');
    ...
    function initMenu() {
        ...
        $('nav:not(.nav-left) a').click(function () {
            if(_menuOn) {
                _menuHide();
            } else {
                _menuShow();
